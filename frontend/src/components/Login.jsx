    ...
    <div className="min-h-screen flex flex-col lg:flex-row font-sans text-white" style={{ background: '#080808', fontFamily: "'Noto Sans Thai', sans-serif" }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden border-r border-white/5">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <img src={heroImage} alt="" className="w-full h-full object-cover object-[right_center] opacity-40 grayscale-[20%] translate-x-16 scale-105" />
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/40 text-xs">change the world.</p>
            </div>
          </div>
        </div>
                ...
                {isSignUp && (
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-none border outline-none transition-all text-white text-sm bg-white/5 focus:bg-white/10 ${confirmPassword && confirmPassword !== password ? 'border-red-500/50' : 'border-white/10 focus:border-[#d4f000]'
                        }`}
                      placeholder="••••••••"
                      required
                    />
